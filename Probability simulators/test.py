...
from monte_carlo_option_pricing import monte_carlo_option_price
...
print("Monte Carlo Option Price (S0=100, K=105, T=1, r=0.05, sigma=0.2):",
      monte_carlo_option_price(100, 105, 1, 0.05, 0.2))
